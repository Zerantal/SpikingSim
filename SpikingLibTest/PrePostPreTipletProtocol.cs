...
namespace SpikingLibTest
{
    ...
    class PrePostPreTipletProtocol
    {
        ...
        {
            // Contract.Requires(prepostpreTriplets != null);
            // Contract.Requires(prepostpreTriplets.Length >= 1);
            // Contract.Requires(prepostpreTriplets.GetLength(1) == 2);
